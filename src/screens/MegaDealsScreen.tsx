...
export default function MegaDealsScreen() {
  ...
  // Filter and sort mega deals (50%+ discount)
  ...
  const productRows = useMemo(() => {
    const rows: (typeof megaDeals)[] = [];

    for (let i = 0; i < megaDeals.length; i += 2) {
      rows.push(megaDeals.slice(i, i + 2));
    }
